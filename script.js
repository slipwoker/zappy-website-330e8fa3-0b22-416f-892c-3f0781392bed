document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (isRequired && value === '') {
        showFieldError(field, getErrorMessage(field, 'required'));
        isValid = false;
      ...
      if (type === 'email') {
        ...
        if (!emailPattern.test(value)) {
          showFieldError(field, getErrorMessage(field, 'email'));
          isValid = false;
          if (!firstInvalidField) firstInvalidField = field;
          return;
        }
      ...
      if (type === 'tel') {
        ...
        if (!telPattern.test(value)) {
          showFieldError(field, getErrorMessage(field, 'tel'));
          isValid = false;
          if (!firstInvalidField) firstInvalidField = field;
          return;
        }
      ...
      if (type === 'url') {
        try {
          ...
          showFieldError(field, getErrorMessage(field, 'url'));
          isValid = false;
          if (!firstInvalidField) firstInvalidField = field;
          return;
        }
      ...
      if (minLength && value.length < parseInt(minLength, 10)) {
        showFieldError(field, getErrorMessage(field, 'minlength', minLength));
        isValid = false;
        if (!firstInvalidField) firstInvalidField = field;
        return;
      }
      ...
      if (maxLength && value.length > parseInt(maxLength, 10)) {
        showFieldError(field, getErrorMessage(field, 'maxlength', maxLength));
        isValid = false;
        if (!firstInvalidField) firstInvalidField = field;
      }
    });
  ...
  function getErrorMessage(field, type, extra) {
    ...
    const messages = {
      ...
      minlength: 'Please enter at least ' + extra + ' characters.',
      maxlength: 'Please enter no more than ' + extra + ' characters.'
    };
  ...
  function handleFormSuccess(form) {
    ...
    successMsg.textContent = form.getAttribute('data-success-message') || 'Thank you! Your message has been sent successfully.';
  ...
  (function applyRTL() {
    ...
    const isRTL = htmlEl.getAttribute('dir') === 'rtl' ||
                  getComputedStyle(htmlEl).direction === 'rtl';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פוקי משחקים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '330e8fa3-0b22-416f-892c-3f0781392bed',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '330e8fa3-0b22-416f-892c-3f0781392bed';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '330e8fa3-0b22-416f-892c-3f0781392bed';
